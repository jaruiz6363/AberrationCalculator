...
internal static class ActionTools
{
    ...
    public static readonly IReadOnlyList<ActionTool> All = new[]
    {
        new ActionTool("optimize",
          ...
          + "better; a spherical one takes his own published table, bit for bit as before. ONE "
          + "design is refused and named: a figured flat facing collimated light, where the "
          + "route that reaches the coefficients is not in the differentiating build. The "
